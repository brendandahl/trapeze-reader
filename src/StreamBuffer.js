...
function StreamBuffer(streamText, bigEndian, start, length) {
	 ...
	 *
	 * @returns {Integer} The position of this buffer
	 */
	 ...
	 * @returns {Integer} The number of elements remaining in this buffer
	 */
	 ...
	 * @param {Integer} start where the new stream will start
	 * @param {Integer} length (optional) defaults to the max new file length
	 ...
	 * @param {Integer} iNumChars (optional) defaults to 1
	 * @returns {char}
	 */
	...
	/**
	 * Read a single character.
	 * @param {Integer} pos The position to read from
	 * @param {Integer} iNumChars (optional) defaults to 1
	 * @returns {char}
	 */
	 ...
	 * @returns {char} returns -1 if the end of the buffer is reached
	 */
	this.peek = function() {
		var z = buffer;
		if(position >= limit)
